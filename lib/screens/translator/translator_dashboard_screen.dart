...
import 'translator_job_detail_screen.dart';

/// Professional translator workspace: jobs, realtime alerts, chat & delivery.
class TranslatorDashboardScreen extends StatefulWidget {
  const TranslatorDashboardScreen({super.key});

  @override
  State<TranslatorDashboardScreen> createState() =>
      _TranslatorDashboardScreenState();
}
